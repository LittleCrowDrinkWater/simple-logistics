...
public class UserController {
    ...
    @PostMapping("/addUser")
    public CustomResponse addUser(@RequestBody User user , @CookieValue("token") String token, HttpServletRequest request) {
    ...
    @PostMapping("/login")
    public CustomResponse login(@RequestBody Map map , HttpServletRequest request, HttpServletResponse response) {
